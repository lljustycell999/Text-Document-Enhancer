...
class GaussianBlur(QWidget):
    ...
    This class provides a GUI for selecting an image and applying Gaussian blur to it.
    The user is able to manually indicate a kernel size with a slider. Additionally, the user can view the original
    grayscale image and a Gaussian blurred image, as well as obtain computer-extracted text from either of these images.
