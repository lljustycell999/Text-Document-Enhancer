...
class OpeningClosing(QWidget):
    ...
    This class provides a GUI for selecting an image and applying an opening-closing morphological operation to it.
    Users can adjust the kernel size and the number of iterations to customize the operation.
    Additionally, the user can view the original grayscale image and an opening-closing image, as well as obtain
